        ...
        <div style="min-height: 524px;">
            ...
            <section class="content-header">
                ...
                <center> <div class="section-title text-center wow zoomIn">
                        <h2>PERFIL ESTUDIANTE <a href="<?php echo base_url();?>estudiante/Perfil/editar"  class="btn " ><span style="color: red;" class="glyphicon glyphicon-pencil"></span></a></h2>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br><br>
                                <center>
                                    <b>Semestre:</b>  <?php $semestre?> <br><br>
                                </center>
                            </div>
                        </div>
