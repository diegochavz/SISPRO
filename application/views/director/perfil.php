        ...
        <div style="min-height: 524px;">
            ...
            <section class="content-header">
                ...
                <center> <div class="section-title text-center wow zoomIn">
                        <h2>PERFIL DIRECTOR DE PROGRAMA <a href="<?php echo base_url();?>director/Perfil/editar"  class="btn " ><span style="color: red;" class="glyphicon glyphicon-pencil"></span></a></h2>
